	...
	return (
		<div className='m-2'>
			...
			<div>
				<div>
					Projected Loss:{' '}
					<span className='text-negative'>-{numeral(cost).format('$0,0.00')}</span>
				</div>
				<div>
					Breakeven Price: <span>{numeral(breakEven).format('$0,0.00')}</span>
				</div>
			</div>
			<table className='w-100 border-b'>
				...
				<tr>
					...
					<td className='text-positive'>
						+{numeral(twoXProceeds).format('$0,0.00')}
					</td>
					<td className='text-positive'>
						+{numeral(fiveXProceeds).format('$0,0.00')}
					</td>
					<td className='text-positive'>
						+{numeral(tenXProceeds).format('$0,0.00')}
					</td>
					<td className='text-positive'>
						+{numeral(twentyXProceeds).format('$0,0.00')}
					</td>
				</tr>
			</table>
		</div>
